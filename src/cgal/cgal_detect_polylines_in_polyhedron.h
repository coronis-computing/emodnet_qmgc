...
#ifndef EMODNET_TOOLS_CGAL_DETECT_POLYLINES_IN_POLYHEDRON_H
#define EMODNET_TOOLS_CGAL_DETECT_POLYLINES_IN_POLYHEDRON_H
namespace CGAL {
...
#endif //EMODNET_TOOLS_CGAL_DETECT_POLYLINES_IN_POLYHEDRON_H
