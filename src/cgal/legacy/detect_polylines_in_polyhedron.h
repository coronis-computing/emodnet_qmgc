...
#ifndef EMODNET_QMGC_CGAL_DETECT_POLYLINES_IN_POLYHEDRON_H
#define EMODNET_QMGC_CGAL_DETECT_POLYLINES_IN_POLYHEDRON_H
namespace CGAL {
...
#endif //EMODNET_QMGC_CGAL_DETECT_POLYLINES_IN_POLYHEDRON_H
